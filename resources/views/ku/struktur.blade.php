...
@section('main')
	...
	<div class="col-md-12 graphs">
	   <div class="xs">
  	 <h3>Wirausaha
  	 <a href="{{url("wirausaha/struktur/$ku->id/create")}}" class="btn btn-danger">Tambah Data</a></h3>
  	 <h3>{{$ku->nama}}</h3>
  {!!Form::open(['method'=>'get','url'=>'wirausaha/struktur/'.$ku->id.'/cari','id'=>'formcari'])!!}
  	 ...
  	 <script >
		...
		$("#cari").change(function() {
		  var cari =  $("#cari").val() ;
		  $("#formcari").attr("action", "{!!url("wirausaha/struktur/$ku->id/cari/")!!}"+"/"+ cari);
		});
  	 })
  	 </script>
