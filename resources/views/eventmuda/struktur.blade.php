...
@section('main')
	...
	<div class="col-md-12 graphs">
  	 ...
  	 <a href="{{url("eventkepemudaan/peserta/$ep->id/create")}}" class="btn btn-danger">Tambah Data</a></h3>
  	 <h3>{{$ep->nama}}</h3>
  {!!Form::open(['method'=>'get','url'=>'eventkepemudaan/peserta/'.$ep->id.'/cari','id'=>'formcari'])!!}
  	 ...
  	 <script >
		...
		$("#cari").change(function() {
		  var cari =  $("#cari").val() ;
		  $("#formcari").attr("action", "{!!url("eventkepemudaan/peserta/$ep->id/cari/")!!}"+"/"+ cari);
		});
  	 })
  	 </script>
